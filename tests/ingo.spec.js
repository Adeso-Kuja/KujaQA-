...
// });
 ...
 test('funding_opportunities', async ({ page }) => {
   test.setTimeout(60000);
   await funding_opportunities(page);
 });


 
  test('partnership_requirements', async ({ page }) => {
   test.setTimeout(60000);
   await partnership_requirements(page);
 });

test('funding_practices', async ({ page }) => {
   test.setTimeout(60000);
   await funding_practices(page);
 });
