...
export async function workwedo ( page ) {
  ...
  await expect(page.getByRole('button', { name: 'Add Add the SDGs you promote' })).toBeVisible({ timeout: 90000 });
  ...
  await expect(page.getByRole('heading', { name: 'SDGs You Promote' })).toBeVisible({ timeout: 90000 });
